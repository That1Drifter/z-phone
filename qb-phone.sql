-- Tweet Comments Table
DROP TABLE IF EXISTS `phone_pulse_likes`;
CREATE TABLE IF NOT EXISTS `phone_pulse_likes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pulseId` varchar(50) DEFAULT NULL,
...
DROP TABLE IF EXISTS `phone_pulse_comments`;
CREATE TABLE IF NOT EXISTS `phone_pulse_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pulseId` varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS `phone_pulses`;
CREATE TABLE IF NOT EXISTS `phone_pulses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `citizenid` varchar(50) DEFAULT NULL,
  ...
  `pulseId` varchar(25) NOT NULL,
  `date` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `citizenid` (`citizenid`)
) ENGINE=InnoDB AUTO_INCREMENT=289 DEFAULT CHARSET=UTF8;

DROP TABLE IF EXISTS `phone_pulse_notifications`;
CREATE TABLE IF NOT EXISTS `phone_pulse_notifications` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
